...
__forceinline static void stlegacy_disable_net_voice(HMODULE mod) {
  BYTE search1[] = {0x83,0xC4,0x04,0x8B,0x46,0x08,0x05,0xD4,0x00,0x00,0x00,0x50,0xFF,0x15,_ANY,_ANY,_ANY,_ANY,0xE8,_ANY,_ANY,_ANY,_ANY,0x8A,0x48,0x28,0x84,0xC9,0x0F,0x84};
  BYTE patch1[] = {0xE9};
