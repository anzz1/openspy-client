...
| Global Operations | <picture><img src="./.github/img/disc.png" title="Retail" alt="(Retail)" /></picture> | `version.dll` | n/a | <sub><sup>[1]</sup> Latest [v2.0 update](https://taco.cab/files/games/glops/glopsus2_0.zip) is recommended</sub> |
